    ...
    $.jBox = function (content, options) {
        ...
        if (options.showFade) {
            if ((isIE6 && $('iframe').length > 0) || $('object, applet').length > 0) {
                boxHtml.push('<iframe id="jbox-fade" class="jbox-fade" src="about:blank" style="display:block;position:absolute;z-index:9999;"></iframe>');
            }
            else {
                if (isIE6) {
        ...
        boxHtml.push('<div id="jbox-temp" class="jbox-temp" style="width:0px;height:0px;background-color:#ff3300;position:absolute;z-index:9999;fdisplay:none;"></div>');
        if (options.draggable) {
            boxHtml.push('<div id="jbox-drag" class="jbox-drag" style="position:absolute;z-index:9999;display:none;"></div>');
        }
